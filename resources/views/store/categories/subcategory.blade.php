...
@section('title', $data['subcategory']->name . ' | ' . $data['subcategory']->category->name)

@section('description', 'Shop for your fashion items in our ' . $data['subcategory']->name . ' category online at Morade Stores')
            ...
            <div class="row">
                <div class="col-sm-12">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="{{ route('store.category.index', $data['subcategory']->category->slug) }}" title="{{ $data['subcategory']->category->name }}">{{ $data['subcategory']->category->name }}</a></li>
                ...
                <div class="row">
                    <div class="col-md-9 padding-right-lg">
                        ...
                        @foreach ($data['chunks'] as $chunk)
                            ...
                            @endforeach
                            @else
                                <h4><i class="glyphicon glyphicon-info-sign"></i>&nbsp;No product in this sub-category.</h4>
                            @endif
