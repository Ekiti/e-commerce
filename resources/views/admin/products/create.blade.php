			...
			<div class="card" style="zoom:" data-height="">
				...
				<div class="card-content collapse show" style="">
					<div class="card-body">
						...
						{{ Form::open(['route' => 'products.store', 'method' => 'POST', 'class' => 'form']) }}
                            <div class="row">
                                <div class="col-md-7">
                                <div class="form-body">
                                ...
                                <div class="col-md-5">
                                    ...
                                    <h4 class="form-section"><i class="la la-list"></i> Category</h4>
                                        ...
                                        <div class="form-actions">
                                            ...
                                            <small class="form-text"><em>After adding this product, you will be redirected to a product images upload page.</em></small>
                                        </div>
                                </div>
                            </div>
						{{ Form::close() }}
