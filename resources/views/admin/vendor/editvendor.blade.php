			...
			<div class="card">
				...
				<div class="card-content collapse show">
					<div class="card-body">
						...
						{{ Form::model($vendor, ['route' => ['vendor.update', $vendor->id], 'method' => 'PUT', 'class' => 'form']) }}
							<div class="row justify-content-md-center">
								<div class="col-md-6">
									<div class="form-body">
										<div class="form-group">
                                            {{ Form::label('vendor_name', 'Company/Brand Name') }}
                                            {{ Form::text('vendor_name', null, ['class' => 'form-control', 'placeholder' => 'name']) }}
										</div>

								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
                                            {{ Form::label('vendor_country', 'Country') }}
                                            {{Form::select('vendor_country',['Nigeria'=>'Nageria'],null,['class'=>'form-control'])}}
										</div>
									</div>

									<div class="col-md-6">
										<div class="form-group">
                                            {{ Form::label('vendor_state', 'State') }}
                                            {{Form::select('vendor_state',['Delta'=>'Delta'],null,['class'=>'form-control'])}}
										</div>
									</div>
                                </div>
								...
								<div class="row">
									<div class="col-md-6">
										<div class="form-group">
                                            {{ Form::label('vendor_city', 'City') }}
                                            {{Form::select('vendor_city',['Warri'=>'Warri'],null,['class'=>'form-control'])}}
										</div>
									</div>
								</div>
										...
										<div class="form-group">
                                            ...
                                            {{ Form::text('vendor_address', null, ['class' => 'form-control', 'placeholder' => 'Address']) }}
										</div>

										<div class="form-group">
                                            {{ Form::label('vendor_phone', 'Phone') }}
                                            {{ Form::text('vendor_phone', null, ['class' => 'form-control', 'placeholder' => 'phone number']) }}
                                        </div>
                                        
                                        <div class="form-group">
                                            {{ Form::label('vendor_description', 'Description') }}
                                            {{ Form::text('vendor_description', null, ['class' => 'form-control', 'placeholder' => 'feel free to brag']) }}
                                        </div>
