...
@section('title', 'shoemake - Edit profile')
				...
				<div class="card-content collapse show">
					<div class="card-body">
                        ...
                        @if($errors->any())
                            ...
                            @endforeach
                        @endif
                        {{ Form::model(Auth::guard('admin')->user(), ['route' => ['updateprofile.admin', Auth::guard('admin')->user()], 'method' => 'PUT', 'class' => 'form']) }}
                        @csrf
								...
								<div class="col-md-6">
									<div class="form-body">
										<div class="form-group">
											<label for="eventInput1">Username</label>
											<input type="text" id="eventInput1" class="form-control" placeholder="Enter your current password" name="name" value="{{ Auth::guard('admin')->user()->name }}">
                                        </div>
                                        <div class="form-group">
											<label for="eventInput1">Email</label>
											<input type="text" id="eventInput1" class="form-control" placeholder="New password" name="email" value="{{ Auth::guard('admin')->user()->email }}">
                                        </div>
									</div>
								</div>
							</div>
