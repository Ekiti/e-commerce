...
@section('title', 'Sizes - Manage Product Sizes')

@section('content-header-left')
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">Sizes</h3>
...
@section('content')
    ...
    <div class="row">
		<div class="col-md-5">
			<div class="card" style="zoom: 1;" data-height="">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form">Add Size</h4>
				...
				<div class="card-content collapse show" style="">
					<div class="card-body">
						...
						<div class="card-text">
							<p>
                                Add a product size to your store. Example <code>XL, L, SM</code>
                            </p>
						</div>

                        @if ($data['isEdit'])

                        {{ Form::model($data['editSize'], ['route' => ['sizes.update', $data['editSize']->id], 'method' => 'PUT', 'class' => 'form']) }}
							<div class="form-body">
								<h4 class="form-section"><i class="la la-list"></i> Size</h4>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
                                            {{ Form::label('name', 'Size') }}
                                            {{ Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Size']) }}
										</div>
									</div>
								</div>
							</div>
						...
						{{ Form::open(['route' => 'sizes.store', 'method' => 'POST', 'class' => 'form']) }}
							<div class="form-body">
								<h4 class="form-section"><i class="la la-credit-card"></i> Size</h4>
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
                                            {{ Form::label('name', 'Size') }}
		...
		<div class="col-md-7">
			<div class="card">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-colored-form-control">All Sizes</h4>
					<a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
					<div class="heading-elements">
						<ul class="list-inline mb-0">
							<li><a data-action="collapse"><i class="ft-minus"></i></a></li>
				...
				<div class="card-content collapse show">
					<div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                                        ...
                                        <td>
                                            <span class="dropdown">
                                                ...
                                                <span aria-labelledby="btnSearchDrop2" class="dropdown-menu mt-1 dropdown-menu-right" x-placement="top-end" style="position: absolute; transform: translate3d(-102px, -177px, 0px); top: 0px; left: 0px; will-change: transform;">
                                                    <a href="{{ route('sizes.show', $size->id) }}" class="dropdown-item"><i class="la la-eye"></i> Open</a>
                                                    <a href="?action=edit&SID={{ $size->id }}" class="dropdown-item"><i class="la la-pencil"></i> Edit</a>
                                                    <a href="{{ route('sizes.destroy', $size->id) }}" class="dropdown-item" onclick="return confirm('Deleting this category will also remove its association with related products. Do you want to continue?')"><i class="la la-trash"></i> Delete</a>
                                                </span>
                                            </span>
                                        </td>
                                    </tr>
                            ...
                            @else
                                <tr>
                                    <th colspan="3"><i class="la la-info-circle"></i>&nbsp;&nbsp;Product sizes you have added will show here.<th>
                                </tr>
                            @endif
                            </tbody>
                    </table>
