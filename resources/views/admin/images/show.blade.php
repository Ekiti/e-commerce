        ...
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Manage product images
                    </li>
                </ol>
            </div>
        </div>
...
@section('content')
		...
		<div class="col-md-12">
			<div class="card" style="zoom:" data-height="">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form">Add Images to <code>{{ $data['product']->name }}</code></h4>
				...
				<div class="card-content collapse show" style="">
					<div class="card-body">
                        ...
                        <div class="col-md-12">
                            {{ Form::open(['route' => ['images.store', $data['product']->id], 'method' => 'POST', 'files' => 'yes', 'class' => 'dropzone form', 'id' => 'myDropzone']) }}
    ...
    <div class="row">
		<div class="col-md-12">
			<div class="card" style="zoom:" data-height="">
				<div class="card-header">
					<h4 class="card-title" id="basic-layout-form">View <code>{{ $data['product']->name }}</code> product images</h4>
					<a class="heading-elements-toggle"><i class="la la-ellipsis-v font-medium-3"></i></a>
					<div class="heading-elements">
						<ul class="list-inline mb-0">
							<li><a data-action="collapse"><i class="ft-minus"></i></a></li>
                                ...
                                @foreach ($data['chunks'] as $chunk)
                                    <div class="column">
                                        @foreach ($chunk as $image)
                                                <a href="{{ route('images.destroy', [$data['product']->id, $image->id]) }}" onclick="return confirm('Are you sure you want to delete this image?')">
                                                    <img src="{{ $image->getImageSource() }}" alt="{{ $data['product']->name }}" class="img-fluid">
                                                </a>
                                        @endforeach
                                    </div>
                                @endforeach
