    ...
    @if (!Cart::isEmpty())
            ...
            <li class="flex no-wrap middle cart-items">
                ...
                <div class="flex flex-wrap mar-lr">
                    <div class="flex no-wrap space-between first-cart-div">
                        <div class="flex">
                            <p><a href="{{ route('product.detail', [$cart->attributes->slug, $cart->attributes->sku]) }}">{{ str_limit($cart->id, $limit=17) }}</a></p>
                        </div>
                        <div class="flex">
                            <p>
        ...
        <div class="flex column no-wrap cart-summary">
            ...
            <div class="flex space-between">
                ...
                <p><b>{{ number_format(Cart::getTotal(), 2) }}</b></p>
            </div>
            <div class="flex space-between">
...
<script src="{{ asset('store/js/payment.js') }}"></script>
...
function payWithPaystack(){
    ...
    //   ref: ''+Math.floor((Math.random() * 1000000000) + 1),  generates a pseudo-unique reference. Please replace with a reference you generated. Or remove the line entirely so our API will generate one for you
      ...
      callback: function(response){
          ...
          window.location = "/verifypayment/" + response.reference;
