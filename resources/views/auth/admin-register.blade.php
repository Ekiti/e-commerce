        ...
        <div class="col-md-4 col-10 box-shadow-2 p-0">
            <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                <div class="card-header border-0">
                    ...
                    <h6 class="card-subtitle line-on-side text-muted text-center font-small-3 pt-2"><span>create a new shoemaka account</span></h6>
                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-md-6 col-12 text-center text-lg-left">
                                    <fieldset>
                                        ...
                                        <label for="remember"> i accept the terms of use of shoemaka</label>
                                    </fieldset>
                                </div>
                            </div>
